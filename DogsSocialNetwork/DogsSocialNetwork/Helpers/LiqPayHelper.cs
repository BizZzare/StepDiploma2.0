...
namespace DogsSocialNetwork.Helpers
{
    public class LiqPayHelper
    {
        ...
        static LiqPayHelper()
        {
            _public_key = "i49428413695";     // Public Key компанії, який можна знайти в особистому кабінеті на сайті liqpay.ua
            _private_key = "59NK5rsR3UwN02lbY9yNvdue3gTmPe8OgNSwTiIr";    // Private Key компанії, який можна знайти в особистому кабінеті на сайті liqpay.ua
        }
        ...
        /// <returns></returns>
        static public LiqPayCheckoutFormModel GetLiqPayModel(string order_id, int userId)
        {
            ...
            var signature_source = new LiqPayCheckout()
            {
                ...
                result_url = "http://localhost:53455/Payment/Redirect?userId=" + userId ,

                product_category = "Pets",
                product_description = "Petoo donation",
